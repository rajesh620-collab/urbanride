...
export default function Navbar() {
  ...
  const navItems = [
    ...
    { label: 'Driver Hub', path: '/driver/dashboard', icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none"><path d="M12 2L4 7v10l8 5 8-5V7L12 2z" stroke="currentColor" strokeWidth="2" strokeLinejoin="round"/><circle cx="12" cy="12" r="2.5" fill="currentColor"/></svg> },
  ];
